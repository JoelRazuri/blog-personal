...
ALLOWED_HOSTS = ['blog-personal-0chw.onrender.com', 'localhost', '127.0.0.1']
...
AWS_S3_CUSTOM_DOMAIN = f"{AWS_STORAGE_BUCKET_NAME}.s3.{AWS_S3_REGION_NAME}.amazonaws.con/media_root"
